...
# optional parameter
simulation_rounds = int(10)  # For monte carlo simulation, a large number of simulations required
...
# MC.stock_price_simulation_with_poisson_jump(jump_alpha=0.1, jump_std=0.25, poisson_lambda=0)
