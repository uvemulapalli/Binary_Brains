...
class MonteCarloOptionPricing:
    ...
    def european_call(self) -> Tuple[float, float]:
        ...
        # print('-' * 64)
        # print("S0 %4.2f, K %4.2f, T %4.2f, Call Option Value %4.3f "
        #       % (self.S0, self.K, self.T, self.expectation))
        # print("S0 %4.2f, K %4.2f, T %4.2f, r %4.2f, Sigma %4.2f, Call Option Value %4.3f "
        #       % (self.S0, self.K, self.T, self.r, self.sigma, self.expectation))
        # print('-' * 64)
